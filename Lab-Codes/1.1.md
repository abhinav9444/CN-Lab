...
- **Modem** – Converts digital signals from a computer into analog signals for transmission over telephone lines. <img src="1.1(a)modem.jpg" alt="Modem" width="800px" height="450px">
- **Access Points (APs)** – Wireless devices that allow Wi-Fi-enabled devices to connect to a wired network. <img src="1.1(a)ap.jpg" alt="Access Points" width="800px" height="450px">
