...
- **Router** – A device that connects different networks and manages traffic between them, often providing internet access. <img src="1.1(a)router.gif" alt="Router" width="800px" height="450px">
- **Modem** – Converts digital signals from a computer into analog signals for transmission over telephone lines. <img src="1.1(a)modem.gif" alt="Modem" width="800px" height="450px">
- **Access Points (APs)** – Wireless devices that allow Wi-Fi-enabled devices to connect to a wired network. <img src="1.1(a)ap.gif" alt="Access Points" width="800px" height="450px">
